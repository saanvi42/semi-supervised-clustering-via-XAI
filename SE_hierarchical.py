...
from SE_hierarchical import SE_hierar_clustering
...
# Path to the dataset
data_path = "datasets/hierarchical/australian.mat"

# Run the clustering and collect metrics
DPs, ARIs, NMIs = SE_hierar_clustering(data_path)
...
plt.xlabel('Run')
plt.ylabel('Score')
plt.title('SE Hierarchical Clustering Performance on australian.mat')
plt.legend()
plt.tight_layout()
plt.show()